...
Mat image_stitch(Mat img_0, Mat img_1) { 
    ...
    {
        finder = ORB::create(10000, 1.2f, 8, 31, 0, 2, ORB::HARRIS_SCORE, 31, 0);
    }
    ...
    {
        finder = xfeatures2d::SIFT::create(); // moved out of xfeatures2d in opencv 4.5
    }
    else
    {
...
int main(int argc, char** argv) {
    ...
    imwrite(result_name, partial_result);
